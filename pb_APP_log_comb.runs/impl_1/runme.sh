...
HD_PWD='C:/Users/Félix/Documents/GitHub/S4_APP1/pb_APP_log_comb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AppCombi_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AppCombi_top.tcl -notrace
